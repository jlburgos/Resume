...
\begin{document} 
  ...
  \begin{resume}
    ...
    \begin{itemize}
      \item Worked with internation team to integrate data-analytics functionality into the IBM Cloud Pak for Multicloud Management performance monitoring product.
