...
\begin{document} 
  ...
  \address{\bf \href{mailto:juanlb1988@gmail.com}{juanlb1988@gmail.com} \\ \href{https://www.linkedin.com/in/juan-burgos-93658b1b/}{https://www.linkedin.com/in/juan-burgos-93658b1b/}}
  ...
  \begin{resume}
    ...
    \textbf{Languages:} Java, C/C++, Ruby, Python, Shell, Lua, \LaTeX.
    ...
    \begin{tabbing}
      ...
      \bf Advisory Software Engineer \>\bf IBM Corporation \>\bf March 2022 - Present\\ \>\bf Austin, TX
    \end{tabbing}\vspace{-10pt}      % suppress blank line after tabbing
    \begin{itemize}
      \item Developing scalable log ingestion and processing capabilities for Instana observability using native Instana sensors and OpenTelemetry.
      \item Developed IBM Cloud Monitoring, Docker, and ContainerD monitoring sensor capabilities for Instana application monitoring that collect and transmit both metrics and logs.
    \end{itemize}\vspace{-18pt}      % suppress blank line after tabbing
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{tabbing}
      \hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
      \bf Staff Software Engineer \>\bf IBM Corporation \>\bf August 2016 - March 2022\\ \>\bf Durham, NC
    \end{tabbing}\vspace{-10pt}      % suppress blank line after tabbing
    \begin{itemize}
      \item Developed a dockerized micro-service that manages per tenant configurations.
