...
\begin{document} 
  ...
  \begin{resume}
    ...
    \begin{tabbing}
      ...
      \bf Advisory Software Engineer \>\bf IBM Corporation \>\bf March 2022 - Present\\ \>\bf Durham, NC
    \end{tabbing}\vspace{-10pt}      % suppress blank line after tabbing
    \begin{itemize}
      \item Developing Log consumption/processing capabilities for the Instana observability and application monitoring.
      \item Developed IBM Cloud Monitoring metric collection capabilities for Instana observability and application monitoring.
